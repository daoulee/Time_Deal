...
export default function ProductsPage() {
  ...
  useEffect(() => {
    ...
    void getCatalog().then((result) => {
      ...
      setNotice(result.notice ?? (result.source === "sample" ? "개발 전용 데이터입니다." : "Supabase 운영 타임딜입니다."));
