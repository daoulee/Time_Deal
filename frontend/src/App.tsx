...
const myPagePaths = ["/mypage", "/mypage/impact", "/mypage/deals", "/mypage/orders", "/mypage/auctions", "/mypage/wishlist", "/mypage/restock-requests", "/mypage/reviews", "/mypage/inquiries", "/mypage/seller-application", "/mypage/security"];
